...
int main(){
    ...
    printf("\nValor del 5to número es: %d",sacarcola(&miPila)); 
    printf("\nValor del 4to número es: %d",sacarcola(&miPila)); 
    printf("\nValor del 3er número es: %d",sacarcola(&miPila));
    printf("\nValor del 2do número es: %d",sacarcola(&miPila));
    printf("\nValor del 1er número es: %d",sacarcola(&miPila));
...
int sacarcola(Pila *p){
	if((isEmpty(*p))==1)
		printf("La pila esta vacia \n");
	else{
		p->lista[p->tope-5]=0;
		p->tope++;
		return p->lista[p->tope-5];
	}
	return 0;
}
